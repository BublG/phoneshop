...
<button onclick="updateCart('${pageContext.servletContext.contextPath}/cart')">
    <spring:message code="cartPage.update.button"/>
</button>
<a href="${pageContext.servletContext.contextPath}/order">
    <button><spring:message code="cartPage.order.button"/></button>
</a>
